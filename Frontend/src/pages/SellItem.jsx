...
import { categories, popularLocations, locationCoordinates } from '../data/products.js';
            ...
            <div class="border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm flex flex-col">
              <div class="aspect-square relative overflow-hidden bg-slate-100 dark:bg-slate-800">
                <img 
                  ...
                  src="${listData.images[0] || 'https://i2c.seadn.io/polygon/0x634386aaf52bafd2bf92f25fd743c25080678a4c/92296516d01c153ee35b016b5657b7/2d92296516d01c153ee35b016b5657b7.png?w=1000'}" 
                  alt="Listing Preview" 
